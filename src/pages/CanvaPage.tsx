...
const ToolCard = ({
  ...
  icon: Icon,
  delay
}: ToolCardProps) => <div className={cn("group relative p-6 rounded-2xl", "bg-[hsl(280_50%_25%_/_0.4)] backdrop-blur-xl border border-[hsl(320_70%_60%_/_0.35)]", "shadow-[0_8px_32px_-4px_hsl(320_70%_55%_/_0.3)] hover:shadow-[0_12px_40px_-4px_hsl(320_70%_55%_/_0.45)] transition-all duration-300", "hover:scale-[1.02] hover:-translate-y-1 hover:bg-[hsl(280_50%_25%_/_0.55)]", "opacity-0 animate-fade-in-up cursor-pointer")} style={{
...
const CanvaPage = () => {
  const aiTools = [{
    title: "טקסט לתמונה",
    description: "יצירת תמונות מקוריות מתיאור טקסטואלי",
    icon: Image
  }, {
    title: "מצגות עם Canva AI",
    description: "בניית מצגות חכמות בלחיצת כפתור",
    icon: Presentation
  }, {
    title: "מסמכים חכמים",
    description: "יצירת מסמכים מעוצבים עם AI",
    icon: FileText
  }, {
    title: "טפסים ויזואליים",
    description: "עיצוב טפסים שמושכים את העין",
    icon: LayoutGrid
  }, {
    title: "תעודות אינטראקטיביות",
    description: "יצירת תעודות הוקרה מרשימות",
    icon: Award
  }, {
    title: "כל אפשרויות Canva AI",
    description: "סקירה מקיפה של כלי ה-AI בקאנבה",
    icon: Sparkles
  }];
  return <Layout>
      {/* Video Section */}
      ...
      <section className="py-4 md:py-6 relative">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold opacity-0 animate-fade-in" style={{
          ...
          <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed opacity-0 animate-fade-in" style={{
      ...
      <section className="py-6 md:py-8">
        <div className="container mx-auto px-4 md:px-6">
          ...
          animationFillMode: "forwards"
        }} className="p-8 md:p-12 rounded-3xl bg-gradient-to-br from-primary/5 via-card to-secondary/5 border border-border/50 shadow-card opacity-0 animate-fade-in-up shadow-lg">
      ...
      <section className="py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3 opacity-0 animate-fade-in" style={{
            animationDelay: "600ms",
            animationFillMode: "forwards"
          }}>
              AI בקאנבה
            </h2>
            <p className="text-muted-foreground text-lg opacity-0 animate-fade-in" style={{
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {aiTools.map((tool, index) => <ToolCard key={tool.title} title={tool.title} description={tool.description} icon={tool.icon} delay={800 + index * 100} />)}
          </div>
        </div>
      </section>
    </Layout>;
