  ...
  <Layout>
    <section className="relative py-16 md:py-24 min-h-[80vh] overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <ScrollAnimation>
          <h1 className="text-4xl md:text-6xl font-handwriting font-bold text-center mb-1"><span className="gradient-text">קצת עליי</span></h1>
          <div className="mb-0 opacity-0 animate-fade-in" style={{ animationDelay: "400ms", animationFillMode: "forwards" }}>
            ...
            <div className="glass-card rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
              ...
              <div className="text-center md:text-right flex-1">
                ...
                <div className="space-y-5 text-muted-foreground leading-relaxed">
                  <p>מלווה מורים במסע אל עולם של יצירתיות, טכנולוגיה והוראה משמעותית. לאורך השנים לימדתי תלמידים, הדרכתי סטודנטים, וכיום אני מתמקדת בהנחיית השתלמויות ביישומי Canva ובכלי בינה מלאכותית (AI) להוראה.</p>
                  <div className="py-3 px-4 rounded-xl bg-primary/10 border border-primary/20">
                    <p className="text-foreground font-medium">✨ טכנולוגיה לא מחליפה מורים – היא מעניקה להם כנפיים</p>
                  </div>
                  <p>אני מאמינה שכלים דיגיטליים מאפשרים לכל מורה, גם ללא רקע בעיצוב, ליצור חומרים מרגשים ולבטא את הרעיונות שלו בצורה הוויזואלית והטובה ביותר.</p>
                  <h3 className="text-xl font-bold text-foreground pt-2">מה זה "מחשבה יוצרת מציאות"?</h3>
                  <p>המרחב הזה הוקם כדי להיות בית תומך ונגיש עבורכם – בין אם אתם עושים את הצעדים הראשונים בעולם הדיגיטלי או מבקשים להעמיק ולהתרחב. כאן תמצאו השראה, חומרים וכלים שיעזרו לכם להוביל הוראה יצירתית וחדשנית.</p>
                </div>
              </div>
            </div>
          </div>
