  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-fade-in-next": { "0%": { opacity: "0", transform: "translateX(-24px)" }, "100%": { opacity: "1", transform: "translateX(0)" } },
        "slide-fade-in-prev": { "0%": { opacity: "0", transform: "translateX(24px)" }, "100%": { opacity: "1", transform: "translateX(0)" } },
      },
      animation: {
        ...
        "slide-fade-next": "slide-fade-in-next 0.35s ease-out",
        "slide-fade-prev": "slide-fade-in-prev 0.35s ease-out",
      },
    },
  },
